...
# Use GTID-purged OFF so dumps restore cleanly on local/dev servers that
# already have executed GTIDs.
DUMP_CMD+=("--single-transaction" "--routines" "--triggers" "--set-gtid-purged=OFF")
